...
namespace PixivDown.PixivDownAbstract
{
    public abstract class PixivDownBase
    {
        protected int count;
    ...
    public abstract class CollectionBase : PixivDownBase
    {
    ...
    public abstract class SingleBase : PixivDownBase
    {
    ...
    {
        PixivDownBase Create(IBaseForm b, Form f, bool IsSingle);
    }


    public class SingleFactory : IPixivDoWorkFactory
    {
        public PixivDownBase Create(IBaseForm b, Form f, bool IsSingle)
        {
            return new Single(b, f, IsSingle);
        }
    }
    ...
    public class AllFollowFactory : IPixivDoWorkFactory
    {
        public PixivDownBase Create(IBaseForm b, Form f, bool IsSingle)
        {
            return new AllFollow(b, f, IsSingle);
        }
    }
    ...
    public class CollectionFactory : IPixivDoWorkFactory
    {
        public PixivDownBase Create(IBaseForm b, Form f, bool IsSingle)
        {
            return new Collection(b, f, IsSingle);
        }
    }
    ...
    public class AuthorCollectionFactory : IPixivDoWorkFactory
    {
        public PixivDownBase Create(IBaseForm b, Form f, bool IsSingle)
        {
            return new AuthorCollection(b, f, IsSingle);
        }
    }
    ...
    public class SearchFactory : IPixivDoWorkFactory
    {
        public PixivDownBase Create(IBaseForm b, Form f, bool IsSingle)
        {
            return new Search(b, f, IsSingle);
        }
    }
